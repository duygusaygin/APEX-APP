...
export const HROUTES: RouteInfo[] = [
  ...
  {
    path: '/order', title: 'Sipariş', icon: 'icon-book-open', class: 'dropdown nav-item has-sub', isExternalLink: false, submenu: []
  },
  {
    ...
    submenu: [
      ...
      },
      {
        ...
        submenu: [
          ...
          { path: '/components/player', title: 'Media Player', icon: 'ft-arrow-right submenu-icon', class: 'dropdown-item', isExternalLink: false, submenu: [] },
